                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-bottom py-20 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-10">
                            <a href="{{ route('admin.branches-of-laws.edit', $branchOfLaw->id) }}" class="btn btn-primary btn-sm">
                                <i class="uil uil-edit me-2"></i>{{ __('common.edit') }}
                            </a>
                            <a href="{{ route('admin.branches-of-laws.index') }}" class="btn btn-light btn-sm">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="view-item">
                                        ...
                                        <p class="fs-15 color-dark fw-500" @if($language->rtl) dir="rtl" @endif>
                                            {{ $branchOfLaw->getTranslation('name', $language->code) ?? '-' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="col-md-6 mb-25">
                                    <div class="view-item">
                                        ...
                                        <p class="fs-15 color-dark" @if($language->rtl) dir="rtl" @endif>
                                            {{ $branchOfLaw->getTranslation('details', $language->code) ?? '-' }}
                                        </p>
                                    </div>
                                </div>
                            @endforeach
                                    ...
                                    <div class="mt-10">
                                        @if($branchOfLaw->image)
                                            <img src="{{ asset('storage/' . $branchOfLaw->image->path) }}" 
                                                 alt="{{ $branchOfLaw->getTranslation('name', app()->getLocale()) }}" 
                            ...
                            <div class="col-md-6 mb-25">
                                <div class="view-item">
                                    ...
                                    <p class="fs-15 color-dark">{{ $branchOfLaw->created_at->format('Y-m-d H:i:s') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-25">
                                <div class="view-item">
                                    ...
                                    <p class="fs-15 color-dark">{{ $branchOfLaw->updated_at->format('Y-m-d H:i:s') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

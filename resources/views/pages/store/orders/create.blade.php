@extends('layout.app')
@section('title', trans('store.create_order'))
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1">{{ trans('store.create_order') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">{{ trans('store.create_order') }}</li>
                </ol>
            </nav>
        </div>
    ...
    <form method="POST" action="{{ route('admin.store.orders.store') }}">
        @csrf
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <textarea name="notes"
                                  class="form-control"
                                  rows="4"
                                  placeholder="{{ trans('store.order_notes') }}">{{ old('notes') }}</textarea>
                    </div>
                </div>
                ...
                <div class="card shadow-sm position-sticky" style="top:20px">
                    <div class="card-body">
                        ...
                        <div class="mb-3 d-flex justify-content-between align-items-center">
                            ...
                            <input type="number" step="0.01" id="tax" name="tax" class="form-control text-end w-50">
                        </div>

                        <div class="mb-3 d-flex justify-content-between align-items-center">
                            <span class="text-muted">{{ trans('store.discount') }}</span>
                            <input type="number" step="0.01" id="discount" name="discount" class="form-control text-end w-50">
                        </div>
                        ...
                        <div class="d-grid gap-2 d-flex justify-content-between">
                            <button class="btn btn-primary btn-lg btn-block">
                                <i class="las la-check"></i> {{ trans('common.create') }}
                            </button>
                        </div>
                    </div>
                </div>

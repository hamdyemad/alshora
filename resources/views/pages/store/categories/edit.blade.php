        ...
        <div class="row">
            <div class="col-lg-12">
                <x-breadcrumb :items="[
                    ...
                    ['title' => trans('store.edit_category')],
                ]" />
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form id="categoryForm"
                            action="{{ route('admin.store.categories.update', $category->id) }}"
                                            ...
                                            <div class="logo-preview-container" id="image-preview-container">
                                                @if($category->image)
                                                    <img src="{{ asset('storage/'.$category->image) }}" 
                                                        alt="Category Image" id="image-preview" class="uploaded-image">
                                                @else
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                categoryForm.addEventListener('submit', function(e) {
                    ...
                    const loadingText = '{{ trans('store.updating_category') }}';
                    ...
                    LoadingOverlay.animateProgressBar(30, 300).then(() => {
                        ...
                        .then(data => {
                            ...
                            return LoadingOverlay.animateProgressBar(100, 200).then(() => {
                                ...
                                const successMessage = '{{ trans('store.category_updated') }}';

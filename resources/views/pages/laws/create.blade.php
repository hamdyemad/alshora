@extends('layout.app')
@section('title', trans('laws.add_law'))
@section('content')
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">{{ trans('laws.add_law') }}</h4>
                <div class="breadcrumb-action justify-content-center flex-wrap">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('laws.add_law') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header color-dark fw-500">
                    <h4>{{ trans('laws.add_law') }} - {{ $branchOfLaw->getTranslation('title', app()->getLocale()) }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.branches-of-laws.laws.store', ['branches_of_law' => $branchOfLaw->id]) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">

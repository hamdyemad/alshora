                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                <li><a class="active" id="st_matrics-today-tab" data-bs-toggle="tab"
                                        href="#st_matrics-today" role="tab" aria-selected="true">Today</a></li>
                                <li><a id="st_matrics-week-tab" data-bs-toggle="tab" href="#st_matrics-week" role="tab"
                                        aria-selected="false">Week</a></li>
                                <li><a id="st_matrics-month-tab" data-bs-toggle="tab" href="#st_matrics-month"
                                        role="tab" aria-selected="false">Month</a></li>
                                <li><a id="st_matrics-year-tab" data-bs-toggle="tab" href="#st_matrics-year" role="tab"
                    ...
                    <div class="card-body p-0 pe-2">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="st_matrics-week" role="tabpanel"
                                aria-labelledby="st_matrics-week-tab">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-social">
                                        <thead>
                                            <tr>
                            ...
                            <div class="tab-pane fade" id="st_matrics-month" role="tabpanel"
                                aria-labelledby="st_matrics-month-tab">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-social">
                                        <thead>
                                            <tr>
                            ...
                            <div class="tab-pane fade" id="st_matrics-year" role="tabpanel"
                                aria-labelledby="st_matrics-year-tab">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-social">
                                        <thead>
                                            <tr>
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                <li>
                                    <a class="active" href="#t_channel-today" data-bs-toggle="tab"
                                        id="t_channel-today-tab" role="tab" aria-selected="true">Today</a>
                                </li>
                                <li>
                                    <a href="#t_channel-week" data-bs-toggle="tab" id="t_channel-week-tab"
                                        role="tab" aria-selected="false">Week</a>
                                </li>
                                <li>
                                    <a href="#t_channel-month" data-bs-toggle="tab" id="t_channel-month-tab"
                                        role="tab" aria-selected="false">Month</a>
                                </li>
                                <li>
                                    <a href="#t_channel-year" data-bs-toggle="tab" id="t_channel-year-tab"
                                        role="tab" aria-selected="false">Year</a>
                                </li>
                            </ul>
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="traffic" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                        class="svg">
                                </a>
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                <li>
                                    <a class="active" href="#t_landing-today" data-bs-toggle="tab"
                                        id="t_landing-today-tab" role="tab" aria-selected="true">Today</a>
                                </li>
                                <li>
                                    <a href="#t_landing-week" data-bs-toggle="tab" id="t_landing-week-tab"
                                        role="tab" aria-selected="false">Week</a>
                                </li>
                                <li>
                                    <a href="#t_landing-month" data-bs-toggle="tab" id="t_landing-month-tab"
                                        role="tab" aria-selected="false">Month</a>
                                </li>
                                <li>
                                    <a href="#t_landing-year" data-bs-toggle="tab" id="t_landing-year-tab"
                                        role="tab" aria-selected="false">Year</a>
                                </li>
                            </ul>
                            <div class="dropdown dropleft">
                                <a href="#" role="button" id="topPage" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                        class="svg">
                                </a>
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-extra">
                            <ul class="card-tab-links nav-tabs nav" role="tablist">
                                ...
                                <li>
                                    <a href="#t_selling-year" data-bs-toggle="tab" id="t_selling-year-tab"
            ...
            <div class="col-xxl-6 mt-30">
                ...
                <div class="card border-0">
                    <div class="card-header">
                        ...
                        <div class="dropdown dropleft">
                            <a href="#" role="button" id="action" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('assets/img/svg/more-horizontal.svg') }}" alt="more-horizontal"
                                    class="svg">
                            </a>
                                        ...
                                        <tr class="draggable" draggable="true">
                                            <td>
                                                <div class="item d-flex align-items-center">
                                                    <img src="{{ asset('assets/img/svg/move.svg') }}" alt="move"
                                                        class="svg">
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <a href="#">
                                                        <img class="svg" src="{{ asset('assets/img/svg/edit.svg') }}"
                                                            alt="edit">
                                                    </a>
                                                    <a href="#">
                                                        <img class="svg"
                                            ...
                                            <td>
                                                <div class="item d-flex align-items-center">
                                                    ...
                                                    <div class="item-info d-flex align-items-center">
                                                        <a href="#"
                                                            class="profile-image rounded-circle d-block m-0 wh-32"
                                                            style="background-image:url('img/tm7.png'); background-size: cover;"></a>
                                                        <div class="item_title">
                                                            <h6>
                                                                <a href="#">Kellie Marquot</a>
                                                            </h6>

...
return [
    ...
    'new_appointment_title' => 'New Appointment Request',
    'new_appointment_body' => ':customer has booked an appointment with you on :date at :time',

    'appointment_status_title' => 'Appointment Status Update',
    'appointment_status_body' => 'Your appointment status has been updated to :status for :date',

    'appointment_confirmed_title' => 'Appointment Confirmed',
    'appointment_confirmed_body' => 'Your appointment on :date at :time has been confirmed',

    'appointment_cancelled_title' => 'Appointment Cancelled',
    'appointment_cancelled_body' => 'Your appointment on :date at :time has been cancelled',
